...
const AIResponse: React.FC<AIResponseProps> = ({
  ...
  return (
    <div className={`ai-response ${variant} ${className}`} data-testid="ai-response">
      {showAvatar && (
...
describe("AIResponse Component", () => {
  ...
  describe("Streaming State", () => {
    it("should show streaming indicator when isStreaming is true", () => {
      render(<AIResponse content="Partial content" isStreaming={true} />);
    ...
    it("should not show copy button when streaming", () => {
      render(<AIResponse content="Streaming content" isStreaming={true} />);
  ...
  describe("Metadata Display", () => {
    it("should show metadata when provided", () => {
      ...
      expect(screen.getByTestId("metadata-tokens")).toHaveTextContent(
        "150 tokens"
      );
      expect(screen.getByTestId("metadata-duration")).toHaveTextContent(
        "1250ms"
      );
    });
    ...
    it("should show partial metadata when only some fields are provided", () => {
      ...
      expect(screen.getByTestId("metadata-model")).toHaveTextContent(
        "claude-3"
      );
      expect(screen.getByTestId("metadata-tokens")).toHaveTextContent(
        "75 tokens"
      ...
      expect(
        screen.queryByTestId("metadata-duration")
