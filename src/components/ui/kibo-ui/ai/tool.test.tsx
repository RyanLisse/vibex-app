...
describe('AIToolHeader', () => {
  ...
  describe('status badges', () => {
    const statuses: AIToolStatus[] = ['pending', 'running', 'completed', 'error']

    it.each(statuses)('should render %s status with correct icon and label', (status) => {
  ...
  describe('interactions', () => {
    ...
    it('should apply custom className', () => {
      render(<AIToolHeader {...defaultProps} className="custom-header-class" />)
