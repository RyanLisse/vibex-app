    ...
    describe('Request schemas', () => {
      ...
      describe('GitHubBranchesRequestSchema', () => {
        ...
        it('should require owner and repo', () => {
          expect(() => GitHubBranchesRequestSchema.parse({ owner: 'test' })).toThrow(/required/)
          expect(() => GitHubBranchesRequestSchema.parse({ repo: 'test' })).toThrow(/required/)
        })
  ...
  describe('Webhook Schemas', () => {
    describe('WebhookPayloadSchema', () => {
      ...
      it('should require event and timestamp', () => {
        expect(() => WebhookPayloadSchema.parse({ event: '' })).toThrow(/required/)
        expect(() =>
  ...
  describe('File Upload Schemas', () => {
    describe('FileUploadRequestSchema', () => {
      ...
      it('should reject files that are too large', () => {
        ...
        expect(() => FileUploadRequestSchema.parse({ file: largeFile })).toThrow(/10MB/)
      })
      ...
      it('should reject unsupported file types', () => {
        ...
        expect(() => FileUploadRequestSchema.parse({ file: unsupportedFile })).toThrow(
          /not supported/
        )
      })
