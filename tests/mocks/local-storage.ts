...
export interface MockIDBDatabase {
  ...
  createObjectStore: vi.MockedFunction<(name: string, options?: IDBObjectStoreParameters) => MockIDBObjectStore>
  deleteObjectStore: vi.MockedFunction<(name: string) => void>
  transaction: vi.MockedFunction<(storeNames: string | string[], mode?: IDBTransactionMode) => MockIDBTransaction>
}
...
export interface MockIDBObjectStore {
  ...
  createIndex: vi.MockedFunction<(name: string, keyPath: string | string[], options?: IDBIndexParameters) => MockIDBIndex>
  ...
  open: vi.fn().mockImplementation((name: string, version?: number) => {
    ...
    setTimeout(() => {
      ...
      const database: MockIDBDatabase = {
        ...
        close: vi.fn(),
        createObjectStore: vi.fn().mockImplementation((storeName: string, options?: IDBObjectStoreParameters) => {
        ...
        transaction: vi.fn().mockImplementation((storeNames: string | string[], mode?: IDBTransactionMode) => {
