...
export const mockResolvedValueOnce = <
...
export const mockRejectedValueOnce = <
	T extends (...args: any[]) => Promise<any>,
>(
	mockFn: MockedFunction<T>,
	error: any,
...
export const mockModulePartial = <T>(
	modulePath: string,
...
export const mockTimers = () => {
	...
	const timeouts: Map<number, { callback: () => void; delay: number }> =
		new Map();
	const intervals: Map<number, { callback: () => void; delay: number }> =
		new Map();
	let nextId = 1;
