...
describe('Enhanced Observability', () => {
  ...
  describe('Metrics', () => {
    test('should track gauge metric in both systems', () => {
      enhancedObservability.trackMetric('cpu.usage', 75.5, 'percent', { server: 'web-1' })
    ...
    test('should track increment metric in both systems', () => {
      enhancedObservability.trackIncrement('api.requests', 1, { endpoint: '/api/users' })
    ...
    test('should track set metric in Sentry', () => {
      enhancedObservability.trackSet('unique.users', 'user123', { region: 'us-east' })
  ...
  describe('Performance Timer', () => {
    test('should create and track timer', async () => {
      const timer = enhancedObservability.createTimer('operation.duration', { type: 'test' })
