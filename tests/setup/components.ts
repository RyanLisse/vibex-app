...
if (typeof window === 'undefined') {
  throw new Error('DOM environment not available - ensure jsdom is properly configured')
}

if (typeof document === 'undefined') {
  throw new Error('Document not available - ensure jsdom is properly initialized')
}
