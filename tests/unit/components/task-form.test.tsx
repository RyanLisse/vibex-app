...
describe("NewTaskForm", () => {
	it("renders form elements correctly", () => {
		const { container, getByPlaceholderText, getByText, queryByRole } = render(
			<NewTaskForm />,
		);

		expect(
			getByPlaceholderText(/describe a task you want to ship/i),
		).toBeInTheDocument();
	...
	it("shows action buttons when text is entered", async () => {
		...
		const input = getByPlaceholderText(
			/describe a task you want to ship/i,
