...
export class PrometheusMetricsCollector {
  ...
  recordAgentCost(agentId: string, agentType: string, provider: string, cost: number): void {
  ...
  recordContextRetrieval(namespace: string, retrievalType: string, duration: number): void {
    this.contextRetrievalDuration.observe({ namespace, retrieval_type: retrievalType }, duration)
  }
