...
export const updateReplicationLag = (
	source: string,
	replica: string,
	lagSeconds: number,
): void => {
...
export const updateIndexMetrics = (
	...
	dbObservabilityMetrics.indexUsage.set(
		{ table, index_name: indexName },
		usageRatio,
	);
	dbObservabilityMetrics.indexSize.set(
		{ table, index_name: indexName },
		sizeBytes,
	);
};

export const updateTableMetrics = (
	table: string,
	sizeBytes: number,
	rowCount: number,
): void => {
...
export const updateWasmMemoryUsage = (
	module: string,
	memoryBytes: number,
): void => {
...
export const updateVectorIndexSize = (
	indexName: string,
	entryCount: number,
): void => {
	dbObservabilityMetrics.vectorIndexSize.set(
