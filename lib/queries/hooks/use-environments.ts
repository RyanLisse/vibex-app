...
export function useActiveEnvironment(
	options?: UseQueryOptions<Environment | null, Error>,
) {
	return useQuery({
...
export function useCreateEnvironment(
	...
	return useMutation({
		...
		onError: (err, newEnvironment, context) => {
			...
			observability.recordError("mutation.environment.create", err, {
...
export function useDeleteEnvironment(
	...
	return useMutation({
		...
		onError: (err, environmentId, context) => {
			...
			observability.recordError("mutation.environment.delete", err, {
				environmentId,
			});
		},
...
export function useActivateEnvironment(
	options?: UseMutationOptions<Environment, Error, string>,
) {
	const queryClient = useQueryClient();
	...
	return useMutation({
		...
		onError: (err, environmentId) => {
			observability.recordError("mutation.environment.activate", err, {
				environmentId,
			});
		},
		onSuccess: (data) => {
...
export function useDeactivateEnvironment() {
	...
	return useMutation({
		mutationFn: (id: string) =>
			updateEnvironment.mutateAsync({ id, data: { isActive: false } }),
	});
}
...
export async function prefetchEnvironment(
