...
if (isVitest()) {
  ...
  testFramework = {
    ...
    expect: (() => {
      ...
      expectFn.arrayContaining = () => console.warn('expect.arrayContaining called in fallback mode');
      expectFn.objectContaining = () => console.warn('expect.objectContaining called in fallback mode');
      expectFn.stringContaining = () => console.warn('expect.stringContaining called in fallback mode');
