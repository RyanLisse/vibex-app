...
describe('Auth Coverage Tests', () => {
  ...
  describe('validateRedirectURL edge cases', () => {
    ...
    it('should reject malformed URLs', () => {
      expect(() => validateRedirectURL('not-a-url')).toThrow('Invalid redirect URL')
      expect(() => validateRedirectURL('')).toThrow('Invalid redirect URL')
      expect(() => validateRedirectURL('://invalid')).toThrow('Invalid redirect URL')
    })
  ...
  describe('URL construction edge cases', () => {
    const buildAuthURL = (baseURL: string, params: Record<string, string>): string => {
