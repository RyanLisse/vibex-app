...
describe('Container Use Integration Types', () => {
  ...
  describe('AgentEnvironment Interface', () => {
    it('should define complete agent environment', () => {
      ...
      expect(['initializing', 'ready', 'running', 'completed', 'failed']).toContain(environment.status);
  ...
  describe('GitWorktree Interface', () => {
    ...
    it('should handle conflict scenarios', () => {
      ...
      expect(['auto', 'manual', 'escalate']).toContain(conflictWorktree.conflictStatus?.resolutionStrategy);
    });
  });
  ...
  describe('VoiceCommand Interface', () => {
    ...
    it('should handle different voice command intents', () => {
      const intents: VoiceCommand['intent']['action'][] = ['create_task', 'check_status', 'modify_task'];
  ...
  describe('AgentState Interface', () => {
    it('should define complete agent state', () => {
      ...
      expect(['idle', 'initializing', 'working', 'waiting', 'completed', 'failed']).toContain(agentState.status);
