...
describe('PerformanceBenchmark', () => {
  ...
  describe('Function Benchmarking', () => {
    it('should measure function execution time', async () => {
      ...
      const result = await benchmark.measureFunction(testFunction, { iterations: 1 })
    ...
    it('should measure function with multiple iterations', async () => {
      ...
      const result = await benchmark.measureFunction(testFunction, { iterations: 5 })
    ...
    it('should handle async functions', async () => {
      ...
      const result = await benchmark.measureFunction(asyncFunction, { iterations: 1 })
  ...
  describe('Component Rendering Benchmarks', () => {
    it('should measure component render time', async () => {
      ...
      const result = await benchmark.measureComponentRender(mockRender, { iterations: 3 })
