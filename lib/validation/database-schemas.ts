...
export const UpdateAgentExecutionSchema =
	CreateAgentExecutionSchema.partial().extend({
...
export const CreateAgentMemorySchema = z.object({
	...
	contextKey: z
		.string()
		.min(1, "Context key is required")
		.max(255, "Context key too long"),
...
export const UpdateWorkflowExecutionSchema =
	CreateWorkflowExecutionSchema.partial().extend({
		id: z.string().uuid("Invalid execution ID"),
		completedAt: z.date().optional(),
		error: z.string().optional(),
	});
...
>;
export type CreateObservabilityEventInput = z.infer<
	typeof CreateObservabilityEventSchema
>;
...
export type CreateWorkflowExecutionInput = z.infer<
	typeof CreateWorkflowExecutionSchema
>;
export type UpdateWorkflowExecutionInput = z.infer<
	typeof UpdateWorkflowExecutionSchema
>;
export type CreateExecutionSnapshotInput = z.infer<
	typeof CreateExecutionSnapshotSchema
>;
