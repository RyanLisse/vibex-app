...
export const env = {
	...
	OPENAI_TOKEN_URL:
		process.env.OPENAI_TOKEN_URL || "https://auth0.openai.com/oauth/token",
	OPENAI_AUTH_URL:
		process.env.OPENAI_AUTH_URL || "https://auth0.openai.com/authorize",
	OPENAI_REVOKE_URL:
		process.env.OPENAI_REVOKE_URL || "https://auth0.openai.com/oauth/revoke",
	...
	ANTHROPIC_TOKEN_URL:
		process.env.ANTHROPIC_TOKEN_URL || "https://auth.anthropic.com/oauth/token",
