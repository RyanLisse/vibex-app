...
export const RouteErrorHandlers = {
   ...
   */
  task: (error: unknown) => handleAPIError(error, {
   ...
   */
  auth: (error: unknown) => handleAPIError(error, {
   ...
   */
  kanban: (error: unknown) => handleAPIError(error, {
   ...
   */
  generic: (error: unknown) => handleAPIError(error, {
    serviceName: 'api',
    recordMetrics: true,
    tracingEnabled: true
  })
