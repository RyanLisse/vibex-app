...
export class AgentLogger {
  ...
  taskAssigned(agentId: string, taskId: string, taskType: string, metadata?: any): void {
  ...
  taskCompleted(agentId: string, taskId: string, duration: number, result: any): void {
  ...
  taskFailed(agentId: string, taskId: string, error: Error, context?: any): void {
...
export class SecurityLogger {
  ...
  authenticationAttempt(userId: string, method: string, success: boolean, metadata?: any): void {
  ...
  unauthorizedAccess(userId: string, resource: string, action: string, ip?: string): void {
  ...
  rateLimitExceeded(userId: string, endpoint: string, limit: number, ip?: string): void {
  ...
  dataAccess(userId: string, dataType: string, action: string, recordCount?: number): void {
...
export class PerformanceLogger {
  ...
  httpRequestTiming(method: string, path: string, statusCode: number, duration: number): void {
