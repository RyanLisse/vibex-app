...
export async function GET(request: NextRequest, { params }: { params: { id: string } }) {
  return BaseAPIHandler.handle(request, async (context) => {
    ...
    const response = ResponseBuilder.success(user, 'User retrieved successfully', context.requestId)
...
export async function PUT(request: NextRequest, { params }: { params: { id: string } }) {
  return BaseAPIHandler.handle(request, async (context) => {
    ...
    const response = ResponseBuilder.updated(user, 'User updated successfully', context.requestId)
...
export async function DELETE(request: NextRequest, { params }: { params: { id: string } }) {
  return BaseAPIHandler.handle(request, async (context) => {
    ...
    const response = ResponseBuilder.deleted('User deactivated successfully', context.requestId)
