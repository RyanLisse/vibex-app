...
export class EnvironmentsAPIService extends BaseCRUDService<any, CreateEnvironmentDTO, any> {
   ...
   */
  async create(envData: CreateEnvironmentDTO, context: ServiceContext): Promise<any> {
   ...
   */
  async update(id: string, updates: any, context: ServiceContext): Promise<any> {
