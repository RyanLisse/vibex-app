...
export async function POST(request: NextRequest) {
  return BaseAPIHandler.handle(request, async (context) => {
    ...
    const body = await BaseAPIHandler.validateBody(request, CreateEnvironmentSchema)
...
export async function PUT(request: NextRequest) {
  return BaseAPIHandler.handle(request, async (context) => {
    // Validate request body
    const body = await BaseAPIHandler.validateBody(request, ActivateEnvironmentSchema)
