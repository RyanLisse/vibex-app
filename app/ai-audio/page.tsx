...
export const metadata: Metadata = {
  ...
  description: 'Experience real-time audio conversations with Google Gemini 2.5 Flash',
}
...
export default function GeminiAudioPage() {
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="mt-8">
        <h2 className="mb-4 text-center text-2xl font-semibold">Features</h2>
      ...
      <div className="mt-8 text-center">
        ...
        <div className="mx-auto max-w-2xl rounded-lg bg-muted p-6 text-left">
          <ol className="list-inside list-decimal space-y-2">
            ...
            <li>Use the microphone button to record audio or type your message</li>
