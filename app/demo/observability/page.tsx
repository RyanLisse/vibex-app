  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="mb-4 font-bold text-4xl">Database Observability Demo</h1>
          <p className="max-w-2xl text-lg text-muted-foreground">
            Explore our comprehensive database observability features including time-travel
            debugging, agent memory management, workflow orchestration, and real-time analytics.
          </p>
        </div>
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-3">
          <div className="rounded-lg border bg-card p-6">
            <h3 className="mb-3 font-semibold text-xl">🕰️ Time-Travel Debugging</h3>
            <p className="text-muted-foreground">
              Step through execution history, compare snapshots, and replay workflows with full
              state visibility for comprehensive debugging.
            </p>
          </div>

          <div className="rounded-lg border bg-card p-6">
            <h3 className="mb-3 font-semibold text-xl">🧠 Agent Memory Browser</h3>
            <p className="text-muted-foreground">
              Semantic search through agent memories, manage learned patterns, and track cross-agent
              knowledge sharing with vector embeddings.
            </p>
          </div>
          ...
          <div className="rounded-lg border bg-card p-6">
            ...
            <p className="text-muted-foreground">
              Visual workflow orchestration with drag-and-drop interface, real-time execution
