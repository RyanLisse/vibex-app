...
// Helper hook for handling environment operations
function useEnvironmentHandlers(
...
const EnvironmentCard = ({
	...
	handleDeleteEnvironment: (id: string, name: string) => Promise<void>;
	handleActivateEnvironment: (id: string) => Promise<void>;
	deleteEnvironmentMutation: any;
	activateEnvironmentMutation: any;
}) => (
	<Card
...
// Environments header component
const EnvironmentsHeader = ({
	environmentsStale,
	...
	return (
		<>
			<div className="mx-auto mt-14 flex w-full max-w-2xl flex-col gap-y-10">
				{/* Header */}
				<EnvironmentsHeader
					environmentsStale={environmentsStale}
					environmentsFetching={environmentsFetching}
				...
				<div className="flex flex-col gap-y-4">
					{isAuthenticated ? (
						environments?.length === 0 ? (
							<EmptyEnvironments setIsDialogOpen={setIsDialogOpen} />
						) : (
							environments?.map((environment) => (
								<EnvironmentCard
									...
									activateEnvironmentMutation={activateEnvironmentMutation}
								/>
							))
						)
					) : (
						<UnauthenticatedState handleGitHubAuth={handleGitHubAuth} />
					)}
				</div>
