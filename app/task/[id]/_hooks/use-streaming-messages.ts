...
interface UseStreamingMessagesProps {
  ...
  onUpdate: (updater: React.SetStateAction<Map<string, StreamingMessage>>) => void
}

export function useStreamingMessages({ streamingMessages, onUpdate }: UseStreamingMessagesProps) {
