...
export function useTaskSubscription({
	...
	const { updateStreamingMessage, removeStreamingMessage, markAsUnmounted } =
					...
					dispatch({
						...
						payload:
							typeof updater === "function"
								? updater(state.streamingMessages)
								: updater,
					});
				}
			},
	...
	const disconnect = (subscriptionResult as { disconnect?: () => void })
		?.disconnect;
