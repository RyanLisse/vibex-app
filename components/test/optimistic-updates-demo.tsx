			...
			<div className="space-y-6">
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Test optimistic updates, cache invalidation, and error handling.
							Changes appear immediately and rollback on errors.
						</CardDescription>
					</CardHeader>
							...
							<AlertDescription>
								<div className="space-y-2">
									...
									<ol className="list-inside list-decimal space-y-1 text-sm">
										<li>
											Create, edit, or delete tasks - changes appear instantly
										</li>
										<li>
											Open DevTools → Network → Throttle to "Slow 3G" to see
											optimistic updates
										</li>
										<li>Disable network to test error rollback behavior</li>
										<li>
											Watch how the UI stays responsive during network
											operations
										</li>
									</ol>
								</div>
								...
								<Card>
									<CardContent className="p-8 text-center">
										<div className="text-muted-foreground">
											...
											<p className="text-sm">
												Create your first task to test optimistic updates
											</p>
										</div>
									</CardContent>
								</Card>
							...
							<Card>
								...
								<CardContent>
									<div className="space-y-2 font-mono text-xs">
										...
										<div>
											Optimistic Tasks:{" "}
											{tasks.filter((t) => t.id.startsWith("temp-")).length}
										</div>
									</div>
								</CardContent>
							</Card>
