		...
		const interval = setInterval(() => {
			if (Math.random() < 0.1) {
				...
				setNetworkLatency((prev) =>
					Math.max(10, prev + (Math.random() - 0.5) * 100),
				);
			}
		}, 2000);
			...
			<div className="flex min-h-screen items-center justify-center">
				<div className="text-center">
					...
					<p className="font-medium text-lg">
						Initializing Database Observability Demo...
					</p>
				...
				<div className="flex items-center justify-between">
					<div>
						...
						<p className="mt-2 text-gray-600 text-lg">
							Comprehensive showcase of ElectricSQL, Enhanced TanStack Query,
							and WASM optimizations
						</p>
					</div>
						...
						<CardContent>
							<div className="space-y-2">
								<div className="flex items-center justify-between">
									...
									<Badge
										variant={isReady && isConnected ? "default" : "destructive"}
									>
								...
								<div className="flex items-center justify-between">
									...
									<Badge
										variant={
											wasmStatus?.health?.overall === "healthy"
												? "default"
												: "secondary"
										}
									>
								...
								<div className="mb-4 flex flex-wrap gap-2">
									{simulatedUsers.map((user) => (
										<Button
											...
											variant={
												currentUser.id === user.id ? "default" : "outline"
											}
										>
							...
							<CardContent>
								{electricLoading || queryLoading ? (
									...
									<div className="py-8 text-center text-red-600">
										Error loading tasks:{" "}
										{(electricTasksError || queryError)?.message}
									</div>
								) : displayTasks?.length ? (
					...
					<TabsContent className="space-y-6" value="collaboration">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									See how multiple users can work together with conflict
									resolution
								</CardDescription>
							</CardHeader>
							<CardContent>
								<div className="space-y-4">
									<div className="grid grid-cols-2 gap-4 md:grid-cols-4">
										{simulatedUsers.map((user) => (
											...
											>
												<div
													className={`h-8 w-8 rounded-full ${user.color} mx-auto mb-2`}
												/>
									...
									<div className="space-y-2">
										...
										<ul className="space-y-1 text-gray-600 text-sm">
											...
											<li>
												• Offline-first architecture with sync when reconnected
											</li>
					...
					<TabsContent className="space-y-6" value="search">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Experience semantic search powered by WebAssembly vector
									operations
								</CardDescription>
							</CardHeader>
							<CardContent>
								<div className="space-y-4">
												...
												<div className="space-y-1">
													...
													{isSemanticSearch && (
														<div className="text-blue-600">
															✨ Using WASM-powered vector search for semantic
															matching
														</div>
													)}
												</div>
									...
									<div className="space-y-2">
										...
										<ul className="space-y-1 text-gray-600 text-sm">
											...
											<li>
												• Semantic search using WASM-optimized vector operations
											</li>
											<li>
					...
					<TabsContent className="space-y-6" value="performance">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Real-time performance monitoring of WASM optimizations and
									database operations
								</CardDescription>
							</CardHeader>
							<CardContent>
								<div className="space-y-6">
									...
									<div className="space-y-4">
										...
										<div className="grid grid-cols-2 gap-4 md:grid-cols-4">
											...
											<div className="rounded-lg border p-3 text-center">
												<div className="font-bold text-2xl text-orange-600">
													{wasmStatus?.stats?.initializationTime?.toFixed(1) ||
														"N/A"}
													ms
												</div>
												<div className="text-gray-600 text-sm">
					...
					<TabsContent className="space-y-6" value="monitoring">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Live monitoring dashboard for database operations and system
									health
								</CardDescription>
							</CardHeader>
							<CardContent>
										...
										<div className="grid grid-cols-1 gap-4 md:grid-cols-3">
											<div className="rounded-lg border p-4">
												<div className="mb-2 flex items-center justify-between">
													...
													<Badge
														variant={
															isReady && isConnected ? "default" : "destructive"
														}
													>
