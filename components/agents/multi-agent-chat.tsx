...
export function MultiAgentChat({
  ...
  return (
    <div className={cn('mx-auto flex h-full max-w-4xl flex-col', className)}>
      <audio className="hidden" onEnded={() => setIsPlayingAudio(false)} ref={audioRef} />
            ...
            <div className="flex items-center gap-2">
              {systemStatus && (
                <>
                  ...
                  <Badge variant="outline">{systemStatus.activeSessions} Sessions</Badge>
                </>
              )}
            </div>
          </div>
            ...
            <div className="p-4">
              {brainstormSession ? (
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="font-semibold">{brainstormSession.topic}</h3>
                          ...
                          <Card key={idea.id}>
                            <CardContent className="p-3">
                              <div className="flex items-center justify-between">
                                ...
                                <Badge variant="secondary">{idea.score}/10</Badge>
                              </div>
                            </CardContent>
                          </Card>
                        ))}
                ...
                <form className="space-y-4" onSubmit={handleBrainstormTopicSubmit}>
                  <div>
            ...
            <div className="space-y-4">
              ...
              {systemStatus && (
                <div className="grid grid-cols-2 gap-4">
                  <Card>
                    <CardContent className="p-3">
                      <div className="font-medium text-sm">Orchestrator Agent</div>
                      <Badge
                        variant={
                  ...
                  <Card>
                    <CardContent className="p-3">
                      <div className="font-medium text-sm">Brainstorm Agent</div>
                      <Badge
                        variant={
