...
vi.mock("@radix-ui/react-select", () => ({
	...
	Separator: ({ className, ...props }: any) => (
		<div
			className={className}
			data-testid="select-separator-primitive"
			{...props}
		/>
	),
	ScrollUpButton: ({ children, className, ...props }: any) => (
		<button
			className={className}
			data-testid="select-scroll-up-primitive"
			{...props}
		>
			{children}
		</button>
	...
	ScrollDownButton: ({ children, className, ...props }: any) => (
		<button
			className={className}
			data-testid="select-scroll-down-primitive"
			{...props}
		>
			{children}
		</button>
...
describe("Select Components", () => {
	...
	describe("SelectValue", () => {
		it("should render value", () => {
			...
			expect(screen.getByTestId("select-value-primitive")).toHaveTextContent(
				"Select an option",
			);
		});
	});
	...
	describe("SelectTrigger", () => {
		...
		it("should render with chevron icon", () => {
			...
			expect(screen.getByTestId("select-trigger-primitive")).toContainHTML(
				"ChevronDownIcon",
			);
		});
	});
	...
	describe("SelectContent", () => {
		...
		it("should render viewport and scroll buttons", () => {
			...
			expect(
				screen.getByTestId("select-scroll-up-primitive"),
			).toBeInTheDocument();
			expect(
				screen.getByTestId("select-scroll-down-primitive"),
			).toBeInTheDocument();
		});
	...
	describe("Select composition", () => {
		it("should render a complete select", () => {
			...
			expect(screen.getByTestId("select-root")).toBeInTheDocument();
			expect(
				screen.getByTestId("select-trigger-primitive"),
			).toBeInTheDocument();
			expect(screen.getByTestId("select-value-primitive")).toBeInTheDocument();
			expect(
				screen.getByTestId("select-content-primitive"),
			).toBeInTheDocument();
			...
			expect(
				screen.getByTestId("select-separator-primitive"),
			).toBeInTheDocument();
		});
