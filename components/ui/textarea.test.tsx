...
describe('Textarea', () => {
  ...
  it('should merge custom className', () => {
    render(<Textarea data-testid="textarea" className="custom-class h-32" />)
  ...
  it('should pass through value prop', () => {
    render(<Textarea data-testid="textarea" value="Initial text" onChange={() => {}} />)
  ...
  it('should handle aria-describedby attribute', () => {
    render(<Textarea data-testid="textarea" aria-describedby="error-message" />)
  ...
  it('should handle aria-label attribute', () => {
    render(<Textarea data-testid="textarea" aria-label="Message input" />)
  ...
  it('should handle autoComplete attribute', () => {
    render(<Textarea data-testid="textarea" autoComplete="off" />)
  ...
  it('should handle autoFocus attribute', () => {
    render(<Textarea data-testid="textarea" autoFocus />)
