...
export function MigrationBanner({
	...
	const { status, startMigration, isMigrating, migrationError } =
		useMigration();
	...
	return (
		<div
			className={`mb-4 rounded-lg border border-blue-200 bg-blue-50 p-4 ${className}`}
		>
			...
			{!(status.migrationCompleted || isMigrating) && (
				<div className="mt-4 border-blue-200 border-t pt-4">
					<div className="mb-2 font-medium text-blue-600 text-xs">
		...
		>
			...
			{isExpanded && (
				<div className="mt-2 text-xs text-yellow-700">
					Migrate your browser data to our new database system for better
