			...
			<Card className="mx-auto w-full max-w-2xl">
				<CardContent className="pt-6">
					<Alert variant="destructive">
						...
						<AlertDescription>
							Failed to load migration status. Please try again.
						</AlertDescription>
					</Alert>
					...
					<div className="space-y-4">
						...
						{migrationStatus.currentMigration.summary.failedRecords > 0 && (
							<Alert>
								<AlertCircle className="h-4 w-4" />
								<AlertDescription>
									{migrationStatus.currentMigration.summary.failedRecords}{" "}
									records failed to migrate. Check the console for details.
								</AlertDescription>
							</Alert>
						)}
		...
		return (
			<Card className="mx-auto w-full max-w-2xl">
				<CardHeader>
					...
					<CardDescription>
						Please wait while we migrate your data to the database.
					</CardDescription>
				</CardHeader>
				<CardContent>
					<div className="space-y-4">
						...
						{currentStep && (
							<div className="rounded-lg border bg-blue-50 p-4">
								...
								<div className="mt-1 text-muted-foreground text-sm">
									{currentStep.recordsProcessed} of {currentStep.totalRecords}{" "}
									records processed
								</div>
							</div>
						)}
	...
	return (
		<Card className="mx-auto w-full max-w-2xl">
			<CardHeader>
				...
				<CardDescription>
					We found data in your browser's local storage that needs to be
			...
			<CardContent>
				<div className="space-y-6">
					...
					<div className="flex justify-end space-x-2">
						...
						<Button
							disabled={
								migrating || !migrationStatus.recommendations.canMigrate
							}
