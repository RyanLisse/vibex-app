          ...
          {metrics && (
            <div className="mb-6 grid grid-cols-2 gap-4 md:grid-cols-4">
              <div className="text-center">
                <div className="font-bold text-2xl text-blue-600">{metrics.activeAgents}</div>
                <div className="text-gray-600 text-sm">Active Agents</div>
                <div className="text-gray-500 text-xs">of {metrics.totalAgents}</div>
              </div>
              <div className="text-center">
                ...
                <div className="text-gray-500 text-xs">of {metrics.totalTasks}</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                <div className="font-bold text-2xl text-orange-600">{metrics.throughput}</div>
          ...
          {metrics && (
            <div className="mb-6">
              <div className="mb-2 flex items-center justify-between">
                ...
                <span className="text-gray-600 text-sm">{metrics.systemLoad}%</span>
              </div>
              ...
              >
                ...
                {agent.currentTask && (
                  <div className="mb-3">
                    ...
                    <div className="truncate font-medium text-sm">{agent.currentTask}</div>
                  </div>
                )}
                ...
                <div className="rounded-lg border p-4" key={task.id}>
                  <div className="mb-3 flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <div className={`h-3 w-3 rounded-full ${getTaskStatusColor(task.status)}`} />
                      <div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="font-medium text-gray-600 text-sm">Agent Type</label>
              ...
              <div>
                <label className="font-medium text-gray-600 text-sm">Capabilities</label>
              ...
              <div>
                <label className="font-medium text-gray-600 text-sm">Performance Metrics</label>
              ...
              <div>
                <label className="font-medium text-gray-600 text-sm">Last Activity</label>
