...
export function ObservabilityDashboard({ defaultTab = 'overview' }: DashboardProps) {
  ...
  useEffect(() => {
    ...
    const loadRecentExecutions = async () => {
      try {
        const response = await fetch('/api/observability/events?type=execution&limit=10')
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
            <Card className="p-6">
              ...
              <div className="mt-2">
                ...
                <div className="text-muted-foreground text-sm">
                  Avg: {metrics?.current?.query_duration?.avg?.toFixed(2) || 0}ms
                </div>
              </div>
            </Card>
            ...
            <Card className="p-6">
              ...
              <div className="mt-2">
                ...
                <div className="text-muted-foreground text-sm">+3 from last hour</div>
              </div>
            </Card>
          ...
          {activeExecution ? (
            ...
            <Card className="p-6">
              <div className="py-12 text-center">
                ...
                <h3 className="mb-2 font-medium text-lg">Time-Travel Debugging</h3>
                <p className="mb-4 text-muted-foreground">
                  Select an execution from the Recent Executions table to start debugging
                </p>
                <DataTable
                  actions={{
                    rowActions: (row: any) => (
